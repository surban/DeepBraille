            ...
            for curveDir in Directory.EnumerateDirectories pageDir do
                yield async {
                    ...
                    return {
                        ...
                        DrivenPos           = tactile.Get "pos"                 :> Arrayd |> ArrayND.mapTC single |> ArrayND.swapDim 0 1
                        DrivenVel           = tactile.Get "vels"                :> Arrayd |> ArrayND.mapTC single |> ArrayND.swapDim 0 1
                        Biotac              = tactile.Get "biotac"              :> Arrayd |> ArrayND.mapTC single |> ArrayND.swapDim 0 1   
                        OptimalVel          = curve.Get "optimal_vels"          :> Arrayd |> ArrayND.mapTC single |> ArrayND.swapDim 0 1
                        DistortionActive    = curve.Get "distortion_actives"                                      |> ArrayND.swapDim 0 1
                        DistortionPos       = curve.Get "distortion_poses"      :> Arrayd |> ArrayND.mapTC single |> ArrayND.swapDim 0 1
                    }
                }
